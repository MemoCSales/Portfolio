(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))c(t);new MutationObserver(t=>{for(const i of t)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&c(a)}).observe(document,{childList:!0,subtree:!0});function r(t){const i={};return t.integrity&&(i.integrity=t.integrity),t.referrerPolicy&&(i.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?i.credentials="include":t.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function c(t){if(t.ep)return;t.ep=!0;const i=r(t);fetch(t.href,i)}})();const o=document.querySelector(".mobile-menu-button"),s=document.querySelector(".mobile-menu");o==null||o.addEventListener("click",()=>{s==null||s.classList.toggle("hidden")});const u=document.querySelectorAll(".mobile-menu .nav-link");u.forEach(e=>{e.addEventListener("click",()=>{s==null||s.classList.add("hidden")})});const m=[{role:"Project Controller Manager",company:"Huawei",duration:"September 2020 - October 2023",achievements:["Managed R$50M+ in purchase orders backlog","Achieved 95% SLA compliance across Brazil, Mexico and Argentina Office","Optimized processes for 100+ national projects"]},{role:"Account Sales Representative",company:"Pack&Pack",duration:"September 2019 - December 2019",achievements:["Increased sales by 15% in 4 montsh through cold calling","Improved sales metrics using client database analysis","Built strong client relationships driving repeat business"]}],p=[{degree:"Software Engineering Student",institution:"🇩🇪 42 Wolfsburg",duration:"November 2023 - Present",achievements:["Building projects in C/C++, Python, and JavaScript using Linux environment","Developed Unix shell with process handling and I/O redirections in C","Created 3D game engine with optimized multi-threading render system","Designed IRC server using OOP and Design Patterns in C++"]},{degree:"Logistics Engineering",institution:"🇲🇽 Universidad de las Américas Puebla",duration:"August 2015 - May 2019",achievements:["Specialized in process optimization using heuristic algorithms","Developed optimization models using FICO Xpress","Applied meta-heuristics for complex logistics problems"]}];function f(e){return`
  ...
  `}const l=document.getElementById("experienceGrid");l&&(l.innerHTML=m.map(e=>f(e)).join(""));const d=document.getElementById("educationGrid");d&&(d.innerHTML=p.map(e=>g(e)).join(""));document.querySelectorAll('a[href^="#"]').forEach(e=>{e.addEventListener("click",function(n){n.preventDefault();const r=document.querySelector(this.getAttribute("href"));r&&r.scrollIntoView({behavior:"smooth",block:"start"})})});
