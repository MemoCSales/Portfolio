...
`;setupCounter(document.querySelector("#counter"));const i=document.querySelector(".mobile-menu-button"),o=document.querySelector(".mobile-menu");i==null||i.addEventListener("click",()=>{o==null||o.classList.toggle("hidden")});const a=document.querySelectorAll(".mobile-menu .nav-link");a.forEach(n=>{n.addEventListener("click",()=>{o==null||o.classList.add("hidden")})});
